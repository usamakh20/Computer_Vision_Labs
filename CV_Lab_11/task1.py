...
def get_data(compression=2, total_sample_size=10000):
    # read the image
    image = read_image('orl_faces/s' + str(1) + '/' + str(1) + '.pgm', 'rw+')
    # reduce the size
    image = image[::compression, ::compression]
    # get the new size
    dim1 = image.shape[0]
    dim2 = image.shape[1]
    ...
    y_genuine = np.zeros(total_sample_size)
    ...
    for i in range(40):
        for j in range(int(total_sample_size / 40)):
            ...
            # reduce the size
            img1 = img1[::compression, ::compression]
            img2 = img2[::compression, ::compression]
    ...
    y_imposite = np.zeros(total_sample_size)
